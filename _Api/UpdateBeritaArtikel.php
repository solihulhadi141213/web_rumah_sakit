<?php
    ...
    if (!is_numeric($limit) || $limit <= 0) {
        respond(['status' => 'error', 'message' => 'Limit harus berupa angka lebih dari 0'], 422);
    }
    ...
    // 6. Update value pada berita_artikel
    $json['berita_artikel'] = [
    ...
    respond([
        'status' => 'success',
        'message' => 'Konten berita_artikel berhasil diperbarui',
        'berita_artikel' => $json['berita_artikel']
    ]);
?>